...
class Tree:
    ...
    def print_sorted_have_two_children(self, node):
        if node.right_son is None and node.left_son is None:
            return

        if node.left_son:
            self.print_sorted_have_two_children(node.left_son)
        if node.right_son and node.left_son:
            print(node.value)
        if node.right_son:
            self.print_sorted_have_two_children(node.right_son)
...
tree.print_sorted_have_two_children(tree.root)
